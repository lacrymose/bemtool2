...
int main(){
    ...
    for (int i=0;i<finesses.size();i++){
        ...
        first_kind_dirichlet_2D(finesses[i], 1., "first_kind_dirichlet_2D");
        first_kind_neumann_2D  (finesses[i], 1., "first_kind_neumann_2D");
        second_kind_dirichlet_2D(finesses[i], 1., "second_kind_dirichlet_2D");
        second_kind_neumann_2D  (finesses[i], 1., "second_kind_neumann_2D");
