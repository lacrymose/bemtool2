...
void potential_hmat_2D(int argc, char* argv[], std::vector<Real> harmonics, Real lc, Real R, std::string output_name, int verbose=0){
...
void potential_hmat_3D(int argc, char* argv[],std::vector<Real> harmonics, Real lc, Real R, std::string output_name, int verbose=0){
	////=====================  Setting for htool  ===================////
...
// 	potential_elt_2D(harmonics,lc,  R, "potential_elt_2D",1);
// 	potential_node_2D(harmonics,lc,  R, "potential_node_2D",1);
// 	potential_elt_3D(harmonics,lc,  R, "potential_elt_3D",1);
// 	potential_node_3D(harmonics,lc,  R, "potential_node_3D",1);
// 	potential_hmat_2D(argc,argv, harmonics,lc,  R, "potential_hmat_2D",1);
	potential_hmat_3D(argc,argv, harmonics,lc,  R, "potential_hmat_3D",1);
